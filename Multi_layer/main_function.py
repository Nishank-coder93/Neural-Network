...
# This module is for plotting components and the implementaion of Neural Net
import main_neural_net as k02  
...
widgets_window.title('Assignment_02 --  Bhatnagar')
# Change the window size here accordingly
widgets_window.minsize(800,400)
